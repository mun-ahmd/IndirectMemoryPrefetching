...
public:
  ...
  // prefetch stats
  uint64_t pf_requested = 0, pf_issued = 0, pf_miss_issued = 0, pf_useful = 0, pf_useless = 0, pf_fill = 0;
  ...
  int prefetch_line(uint64_t pf_addr, bool fill_this_level, uint64_t prefetch_metadata, uint8_t size, bool unsign_ext);
  int prefetch_line(uint64_t pf_addr, bool fill_this_level, uint64_t prefetch_metadata);
  int prefetch_line(uint64_t pf_addr, bool fill_this_level, uint64_t prefetch_metadata, uint64_t ip);
